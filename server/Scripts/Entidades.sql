...
INSERT INTO usuario(nombre, email, contrasena_hash, ROL_codigo, creado_en, activo, es_provisional)
VALUES 
('Administrador', 'administrador@uca.edu.sv', '$2a$10$K7HufdmPI16g56n8O2hQtuk4mQ1RoXmx3uWB7AQO0FsIrjloRtTWG', 'ROL_1', CURRENT_TIMESTAMP, TRUE, TRUE);
...
INSERT INTO usuario(nombre, email, contrasena_hash, ROL_codigo, creado_en, activo, es_provisional)
VALUES 
('AdminTest', 'administrador1@uca.edu.sv', '$2a$10$K7HufdmPI16g56n8O2hQtuk4mQ1RoXmx3uWB7AQO0FsIrjloRtTWG', 'ROL_1', CURRENT_TIMESTAMP, TRUE, FALSE);
