...
const Registros = () => {
  ...
  const columns = [
    ...
    { key: "flagViolencia", title: "hubo violencia" },
    { key: "flagDetencion", title: "hubo detención" },
    { key: "flagExpresion", title: "hubo expresión" },
    { key: "flagJusticia", title: "hubo justicia" },
    { key: "flagCensura", title: "hubo censura" },
