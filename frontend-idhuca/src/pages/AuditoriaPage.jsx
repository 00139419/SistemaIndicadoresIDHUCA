        ...
        <>
          ...
          <div className="row mb-4">
            <div className="col-md-3">
              <label htmlFor="filterUsuario" className="form-label">Filtrar por Usuario:</label>
              <input
                type="text"
            ...
            <div className="col-md-3">
              <label htmlFor="filterTabla" className="form-label">Filtrar por Tabla:</label>
              <input
                type="text"
                className="form-control"
                id="filterTabla"
            ...
            <div className="col-md-3">
              <label htmlFor="filterOperacion" className="form-label">Filtrar por Operación:</label>
              <input
                type="text"
                className="form-control"
                id="filterOperacion"
